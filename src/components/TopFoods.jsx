      ...
      <div className='flex flex-col lg:flex-row justify-between'>
        <div>
          ...
          <div className='flex justify-between flex-wrap'>
            ...
            <button onClick={() => filterType('bebidas')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
              Bebidas
            </button>
            <button onClick={() => filterType('sobremesa')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
              Sobremesa
            </button>
          </div>
        </div>
        ...
        <div>
          ...
          <div className='flex justify-between max-w-[390px] w-full'>
            <button onClick={() => filterPrice('20.00')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
              20,00
            </button>
            <button onClick={() => filterPrice('40.00')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
              40,00
            </button>
            <button onClick={() => filterPrice('60.00')} className='m-1 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white'>
              60,00
            </button>
          </div>
        </div>
        ...
        {foods.map((item, index) => (
          <div key={index} className='border shadow-lg rounded-lg hover:scale-105 duration-300'>
            ...
            <div className='flex justify-center'>
              <button onClick={() => openModal(item)} className='bg-orange-600 text-white border-none rounded-full text-2xl mb-2 hover:bg-orange-500'>
